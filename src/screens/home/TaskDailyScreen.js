...
export default function TaskDailyScreen({navigation}) {
        ...
        <>
            ...
            <Container>
                <View className="mb-1 space-y-1">
                    <Text className="text-3xl font-bold">Daily Task</Text>
                    <Text className="text-lg text-gray-600 ">Complete Your Daily Task💡</Text>
                </View>
                <View className="mb-4">
                    <Input
                        placeholder="Search"
