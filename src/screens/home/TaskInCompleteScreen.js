...
export default function TaskInCompleteScreen({navigation}) {
    ...
    const filteredData = noCompleteData.filter(task => {
        ...
        <>
            ...
            <Container>
                <View className="mb-1 space-y-1">
                    <Text className="text-3xl font-bold">InComplete Task</Text>
                    <Text className="text-lg text-gray-600 ">Complete Your InComplete Task 😥 </Text>
                </View>
                <View className="mb-4">
                    <Input
                        placeholder="Search"
