...
export default function TaskCompleteScreen({navigation}) {
    ...
    const filteredData = completeData.filter(task => {
        ...
        <>
            ...
            <Container>
                <View className="mb-1 space-y-1">
                    <Text className="text-3xl font-bold">Complete Task</Text>
                    <Text className="text-lg text-gray-600 ">Congratulations! you have complete Task 🎉</Text>
                </View>
                <View className="mb-4">
                    <Input
                        placeholder="Search"
